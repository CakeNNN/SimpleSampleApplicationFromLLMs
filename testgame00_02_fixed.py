...
for _ in range(enemy_count):
    ...
    enemy_direction = [0, 0]
    enemy_timer = 60  # プレイヤー方向に移動する時間（フレーム数）
    enemies.append([enemy_pos, enemy_direction, enemy_timer])
...
while not game_over:
    ...
    for enemy in enemies:
        enemy_pos, enemy_direction, enemy_timer = enemy
        ...
        # 画面外に出たら消滅
        if enemy_pos[0] < 0 or enemy_pos[0] > screen_width or enemy_pos[1] < 0 or enemy_pos[1] > screen_height:
